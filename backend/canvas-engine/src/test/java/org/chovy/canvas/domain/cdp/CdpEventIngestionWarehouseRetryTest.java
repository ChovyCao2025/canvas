...
class CdpEventIngestionWarehouseRetryTest {

    @Test
    void warehouseSinkFailureEnqueuesRealtimeRetryWithoutRejectingEvent() {
        ...
        CdpEventIngestionService service = service(sink, retryService);
        ...
        verify(retryService).enqueueFailure(row.capture(), contains("doris unavailable"));
