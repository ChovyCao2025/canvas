...
class IfConditionHandlerTest {
    ...
    void setUp() {
        ...
        ctx.putRuntimeContextValue("userId", "user_001");
        ctx.putRuntimeContextValue("orderStatus", "PAID");
        ctx.putRuntimeContextValue("amount", "500");
        ctx.putRuntimeContextValue("marketIdentity", "newUser");
    ...
    class ContainsIn {
        ...
        void contains_substring_without_comma() {
            // 无逗号时退化为子串匹配
            ctx.putRuntimeContextValue("desc", "机票订单已支付");
    ...
    class NumericCompare {
        ...
        void lt_numeric_10_vs_9() {
            ...
            ctx.putRuntimeContextValue("count", "10");
        ...
        void invalid_numeric_values_do_not_match_order_comparisons() {
            ctx.putRuntimeContextValue("amount", "unknown");
            Map<String, Object> rule = rule("amount", "GT", "50");
