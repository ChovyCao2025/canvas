...
public class TagDefinitionService {
    ...
    public List<TagDefinition> list(String tagType, Integer enabled) {
        return tagDefinitionMapper.selectList(new LambdaQueryWrapper<TagDefinition>()
    ...
    public void delete(Long id) {
        ...
        Long count = userTagCurrentMapper.selectCount(new LambdaQueryWrapper<UserTagCurrent>()
                .eq(UserTagCurrent::getTagCode, existing.getTagCode()));
    ...
    public void deleteValue(Long id) {
        ...
        Long count = userTagCurrentMapper.selectCount(new LambdaQueryWrapper<UserTagCurrent>()
                .eq(UserTagCurrent::getTagCode, existing.getTagCode())
                .eq(UserTagCurrent::getTagValue, existing.getValue()));
        if (count != null && count > 0) {
    ...
    private static String normalizeValueType(String valueType) {
        ...
        if (!"STRING".equals(normalized) && !"NUMBER".equals(normalized) && !"BOOLEAN".equals(normalized)) {
