 ...
 * 展示已提交技术迁移证据的只读视图。
 */
public final class TechnicalMigrationEvidenceView {
     ...
     */
    public TechnicalMigrationEvidenceView(
            Long tenantId,
            String candidateKey,
            String proofCommand,
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TechnicalMigrationEvidenceView that)) {
            return false;
        }
    ...
    public String toString() {
        return "TechnicalMigrationEvidenceView[tenantId=" + tenantId
