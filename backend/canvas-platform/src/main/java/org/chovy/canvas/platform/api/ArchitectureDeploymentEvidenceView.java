 ...
 * 展示已登记架构部署证据的只读视图。
 */
public final class ArchitectureDeploymentEvidenceView {
     ...
     */
    public ArchitectureDeploymentEvidenceView(
            String candidateKey,
            String ownerId,
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ArchitectureDeploymentEvidenceView that)) {
            return false;
        }
    ...
    public String toString() {
        return "ArchitectureDeploymentEvidenceView[candidateKey=" + candidateKey
                + ", ownerId=" + ownerId
