...
/**
 * 表示MarketingCampaignLink的数据结构。
 */
public final class MarketingCampaignLink {
     ...
     * 关联资源业务键。
     */
    private final CampaignKey resourceKey;
     ...
     * 资源关联状态。
     */
    private final CampaignLinkStatus linkStatus;
    ...
    /**
     * 创建MarketingCampaignLink实例。
     */
    public MarketingCampaignLink(Long id, Long tenantId, Long campaignId, String resourceType, Long resourceId, CampaignKey resourceKey, String resourceName, String resourceRoute, String dependencyRole, CampaignLinkStatus linkStatus, boolean requiredForLaunch, Map<String, Object> metadata, String createdBy, String updatedBy, LocalDateTime createdAt, LocalDateTime updatedAt) {
     ...
     * 返回关联资源业务键。
     */
    public CampaignKey resourceKey() {
        return resourceKey;
    }
     ...
     * 返回资源关联状态。
     */
    public CampaignLinkStatus linkStatus() {
        return linkStatus;
    }
    ...
    public boolean equals(Object o) {
        ...
        MarketingCampaignLink that = (MarketingCampaignLink) o;
    ...
    public String toString() {
        return "MarketingCampaignLink[id=" + id + ", tenantId=" + tenantId + ", campaignId=" + campaignId + ", resourceType=" + resourceType + ", resourceId=" + resourceId + ", resourceKey=" + resourceKey + ", resourceName=" + resourceName + ", resourceRoute=" + resourceRoute + ", dependencyRole=" + dependencyRole + ", linkStatus=" + linkStatus + ", requiredForLaunch=" + requiredForLaunch + ", metadata=" + metadata + ", createdBy=" + createdBy + ", updatedBy=" + updatedBy + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + "]";
    }
}
