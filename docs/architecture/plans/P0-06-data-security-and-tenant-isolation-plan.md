...
**Goal:** Execute the architecture remediation package described in `../specs/P0-06-data-security-and-tenant-isolation-spec.md`.
...
- Read: `../specs/P0-06-data-security-and-tenant-isolation-spec.md`
- Read: `../todo/coverage-matrix.md`
- Read: `../todo/p0/data-security-and-tenant-isolation/plan.md`
...
Read `../specs/P0-06-data-security-and-tenant-isolation-spec.md` and write the smallest failing test or documentation check that demonstrates this task gap before changing implementation files.
...
Change only the files required by this task and keep the behavior aligned with the acceptance criteria in `../specs/P0-06-data-security-and-tenant-isolation-spec.md`.
