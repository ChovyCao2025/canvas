...
**Goal:** Execute the architecture remediation package described in `../specs/P1-02-api-contract-and-validation-spec.md`.
...
- Read: `../specs/P1-02-api-contract-and-validation-spec.md`
- Read: `../todo/coverage-matrix.md`
- Read: `../todo/p1/api-contract-and-validation/plan.md`
...
Read `../specs/P1-02-api-contract-and-validation-spec.md` and write the smallest failing test or documentation check that demonstrates this task gap before changing implementation files.
...
Change only the files required by this task and keep the behavior aligned with the acceptance criteria in `../specs/P1-02-api-contract-and-validation-spec.md`.
...
### Task 2: Add DTO validation annotations for create/update/execute/report endpoints first
...
### Task 4: Update `GlobalExceptionHandler` mappings
...
### Task 5: Type frontend service calls for canvas, execution, metadata, and auth APIs
...
### Task 6: Add controller tests for validation failures and authorization failures
