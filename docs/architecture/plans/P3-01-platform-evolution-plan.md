...
- Read: `docs/architecture/specs/P3-01-platform-evolution-spec.md`
...
- Create: `docs/architecture/platform-evolution-promotion-checklist.md`
- Read: `docs/architecture/specs/P3-01-platform-evolution-spec.md`
- Read: `docs/architecture/plans/P3-02-service-decomposition-and-domain-boundaries-plan.md`
- Read: `docs/architecture/plans/P3-03-data-platform-architecture-plan.md`
- Read: `docs/architecture/plans/P3-06-k8s-deployment-platform-plan.md`
...
- Read: `docs/architecture/specs/P0-01-security-hardening-spec.md`
- Read: `docs/architecture/specs/P0-03-canvas-state-data-consistency-spec.md`
- Read: `docs/architecture/specs/P1-04-observability-and-ops-spec.md`
- Read: `docs/architecture/specs/P1-05-release-deployment-governance-spec.md`
...
- Read: `docs/architecture/specs/P3-04-multi-datasource-isolation-spec.md`
- Read: `docs/architecture/specs/P3-05-webflux-to-mvc-migration-spec.md`
- Read: `docs/architecture/specs/P3-06-k8s-deployment-platform-spec.md`
- Read: `docs/architecture/specs/P3-07-production-platform-components-spec.md`
- Read: `docs/architecture/specs/P3-08-wecom-scrm-module-spec.md`
- Read: `docs/architecture/specs/P3-09-identity-event-and-tenant-platform-spec.md`
...
**Files:**
- Modify: `docs/architecture/plans/P3-01-platform-evolution-plan.md`
- Modify: `docs/architecture/plans/README.md`
- Modify: `docs/architecture/todo/coverage-matrix.md`
- Create: `docs/architecture/evidence/p3-01-platform-evolution.md`
- Create: `docs/architecture/platform-evolution-promotion-checklist.md`
...
**Run:**
```bash
git diff -- docs/architecture/plans/P3-01-platform-evolution-plan.md docs/architecture/plans/README.md docs/architecture/todo/coverage-matrix.md docs/architecture/evidence/p3-01-platform-evolution.md docs/architecture/platform-evolution-promotion-checklist.md
```
