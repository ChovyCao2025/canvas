...
**Goal:** Execute the architecture remediation package described in `../specs/P3-01-platform-evolution-spec.md`.
...
- Read: `../specs/P3-01-platform-evolution-spec.md`
- Read: `../todo/coverage-matrix.md`
- Read: `../todo/p3/platform-evolution/plan.md`
...
Read `../specs/P3-01-platform-evolution-spec.md` and write the smallest failing test or documentation check that demonstrates this task gap before changing implementation files.
...
Change only the files required by this task and keep the behavior aligned with the acceptance criteria in `../specs/P3-01-platform-evolution-spec.md`.
...
Read `../specs/P3-01-platform-evolution-spec.md` plus the matching focused P3 spec and write the smallest failing test or documentation check that demonstrates this task gap before changing implementation files.
