...
**Goal:** Execute the architecture remediation package described in `../specs/P2-05-compliance-data-governance-spec.md`.
...
- Read: `../specs/P2-05-compliance-data-governance-spec.md`
- Read: `../todo/coverage-matrix.md`
- Read: `../todo/p2/compliance-data-governance/plan.md`
...
Read `../specs/P2-05-compliance-data-governance-spec.md` and write the smallest failing test or documentation check that demonstrates this task gap before changing implementation files.
...
Change only the files required by this task and keep the behavior aligned with the acceptance criteria in `../specs/P2-05-compliance-data-governance-spec.md`.
...
### Task 5: Extend suppression/consent checks
