...
These commands cover the pre-load backend unit guard and perf tooling preflight from the runbooks. Full load execution remains a manual item tracked by `docs/architecture/testing/manual-verification.md`.
