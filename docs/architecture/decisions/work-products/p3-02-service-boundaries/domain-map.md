...
Status: Active modular-monolith boundary map. Physical service extraction remains blocked by `docs/architecture/decisions/adr/ADR-0006-service-extraction-gate.md`.
...
Scoring uses 1 as easiest/lowest risk and 5 as hardest/highest risk. The decision in `docs/architecture/decisions/adr/ADR-0007-first-extraction-candidate.md` is `Deferred` for physical extraction.
