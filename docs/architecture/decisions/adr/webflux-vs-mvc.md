...
- P0 reactive review candidates in `docs/architecture/decisions/work-products/p3-05-runtime-model/webflux-mvc-migration-inventory.md` are closed or risk-accepted by owner.
