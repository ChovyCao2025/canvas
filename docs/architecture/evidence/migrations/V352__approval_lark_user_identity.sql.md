# V352 approval lark user identity

Migration: `V352__approval_lark_user_identity.sql`

Touched tables identified from the migration SQL:

- `approval_lark_user_identity`
...
export MIGRATION_ID=V352__approval_lark_user_identity
export TABLES="approval_lark_user_identity"
