# V324 programmatic dsp foundation

Migration: `V324__programmatic_dsp_foundation.sql`

Touched tables identified from the migration SQL:

- `programmatic_dsp_campaign`
- `programmatic_dsp_line_item`
- `programmatic_dsp_performance_snapshot`
- `programmatic_dsp_seat`
- `programmatic_dsp_supply_path`
...
export MIGRATION_ID=V324__programmatic_dsp_foundation
export TABLES="programmatic_dsp_campaign programmatic_dsp_line_item programmatic_dsp_performance_snapshot programmatic_dsp_seat programmatic_dsp_supply_path"
