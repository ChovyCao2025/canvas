# V276 ab experiment metrics governance

Migration: `V276__ab_experiment_metrics_governance.sql`

Touched tables identified from the migration SQL:

- `ab_experiment_allocation`
- `ab_experiment_governance_decision`
- `ab_experiment_layer`
- `ab_experiment_metric`
- `ab_experiment_metric_snapshot`
...
export MIGRATION_ID=V276__ab_experiment_metrics_governance
export TABLES="ab_experiment_allocation ab_experiment_governance_decision ab_experiment_layer ab_experiment_metric ab_experiment_metric_snapshot"
