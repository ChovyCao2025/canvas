# V260 bi export progress retry

Migration: `V260__bi_export_progress_retry.sql`
...
export MIGRATION_ID=V260__bi_export_progress_retry
export TABLES="bi_export_job"
