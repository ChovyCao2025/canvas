# V257 marketing forms lead capture

Migration: `V257__marketing_forms_lead_capture.sql`

Touched tables identified from the migration SQL:

- `marketing_form_definition`
...
export MIGRATION_ID=V257__marketing_forms_lead_capture
export TABLES="marketing_form_definition marketing_form_submission"
