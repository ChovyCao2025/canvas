# V325 monitoring anomaly detection

Migration: `V325__monitoring_anomaly_detection.sql`

Touched tables identified from the migration SQL:

- `marketing_monitor_anomaly_event`
- `marketing_monitor_anomaly_rule`
...
export MIGRATION_ID=V325__monitoring_anomaly_detection
export TABLES="marketing_monitor_anomaly_event marketing_monitor_anomaly_rule"
