# V313 bi dataset extract retention

Migration: `V313__bi_dataset_extract_retention.sql`
...
export MIGRATION_ID=V313__bi_dataset_extract_retention
export TABLES="bi_dataset_extract_refresh_run"
