# V347 marketing integration contract audit events

Migration: `V347__marketing_integration_contract_audit_events.sql`

Touched tables identified from the migration SQL:

- `marketing_integration_contract_audit_event`
...
export MIGRATION_ID=V347__marketing_integration_contract_audit_events
export TABLES="marketing_integration_contract_audit_event"
