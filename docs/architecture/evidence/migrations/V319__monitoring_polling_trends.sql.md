# V319 monitoring polling trends

Migration: `V319__monitoring_polling_trends.sql`

Touched tables identified from the migration SQL:

- `marketing_monitor_poll_run`
- `marketing_monitor_source`
- `marketing_monitor_trend_snapshot`
...
export MIGRATION_ID=V319__monitoring_polling_trends
export TABLES="marketing_monitor_poll_run marketing_monitor_source marketing_monitor_trend_snapshot"
