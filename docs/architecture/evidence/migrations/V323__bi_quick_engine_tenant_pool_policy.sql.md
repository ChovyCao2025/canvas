# V323 bi quick engine tenant pool policy

Migration: `V323__bi_quick_engine_tenant_pool_policy.sql`

Touched tables identified from the migration SQL:

- `bi_quick_engine_capacity_policy`
...
export MIGRATION_ID=V323__bi_quick_engine_tenant_pool_policy
export TABLES="bi_quick_engine_capacity_policy"
