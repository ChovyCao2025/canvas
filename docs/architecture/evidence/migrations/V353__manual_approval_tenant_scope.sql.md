# V353 manual approval tenant scope

Migration: `V353__manual_approval_tenant_scope.sql`
...
export MIGRATION_ID=V353__manual_approval_tenant_scope
export TABLES="canvas_manual_approval"
