# V275 bi big screen spreadsheet resources

Migration: `V275__bi_big_screen_spreadsheet_resources.sql`

Touched tables identified from the migration SQL:

- `bi_big_screen`
- `bi_big_screen_version`
- `bi_spreadsheet`
- `bi_spreadsheet_version`
...
export MIGRATION_ID=V275__bi_big_screen_spreadsheet_resources
export TABLES="bi_big_screen bi_big_screen_version bi_spreadsheet bi_spreadsheet_version"
