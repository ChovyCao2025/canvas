# V340 programmatic dsp mutation gateway

Migration: `V340__programmatic_dsp_mutation_gateway.sql`

Touched tables identified from the migration SQL:

- `programmatic_dsp_mutation`
...
export MIGRATION_ID=V340__programmatic_dsp_mutation_gateway
export TABLES="programmatic_dsp_mutation"
