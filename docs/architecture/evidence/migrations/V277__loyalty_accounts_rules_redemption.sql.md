# V277 loyalty accounts rules redemption

Migration: `V277__loyalty_accounts_rules_redemption.sql`

Touched tables identified from the migration SQL:

- `loyalty_member_account`
- `loyalty_redemption`
- `loyalty_rule`
- `loyalty_transaction_journal`
...
export MIGRATION_ID=V277__loyalty_accounts_rules_redemption
export TABLES="loyalty_member_account loyalty_redemption loyalty_rule loyalty_transaction_journal"
