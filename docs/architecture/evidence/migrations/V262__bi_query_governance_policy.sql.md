# V262 bi query governance policy

Migration: `V262__bi_query_governance_policy.sql`
...
export MIGRATION_ID=V262__bi_query_governance_policy
export TABLES="bi_query_governance_policy"
