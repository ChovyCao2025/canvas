# V338 search marketing mutation gateway

Migration: `V338__search_marketing_mutation_gateway.sql`

Touched tables identified from the migration SQL:

- `search_marketing_mutation`
...
export MIGRATION_ID=V338__search_marketing_mutation_gateway
export TABLES="search_marketing_mutation"
