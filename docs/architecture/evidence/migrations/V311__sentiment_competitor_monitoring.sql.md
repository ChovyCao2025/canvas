# V311 sentiment competitor monitoring

Migration: `V311__sentiment_competitor_monitoring.sql`

Touched tables identified from the migration SQL:

- `marketing_competitor_mention`
- `marketing_monitor_alert`
- `marketing_monitor_item`
...
export MIGRATION_ID=V311__sentiment_competitor_monitoring
export TABLES="marketing_competitor_mention marketing_monitor_alert marketing_monitor_item marketing_monitor_source marketing_sentiment_analysis"
