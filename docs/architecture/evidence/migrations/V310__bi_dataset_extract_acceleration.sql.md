# V310 bi dataset extract acceleration

Migration: `V310__bi_dataset_extract_acceleration.sql`

Touched tables identified from the migration SQL:

- `bi_dataset_acceleration_policy`
- `bi_dataset_extract_refresh_run`
...
export MIGRATION_ID=V310__bi_dataset_extract_acceleration
export TABLES="bi_dataset_acceleration_policy bi_dataset_extract_refresh_run"
