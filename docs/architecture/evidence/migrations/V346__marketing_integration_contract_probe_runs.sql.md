# V346 marketing integration contract probe runs

Migration: `V346__marketing_integration_contract_probe_runs.sql`

Touched tables identified from the migration SQL:

- `marketing_integration_contract_probe_run`
...
export MIGRATION_ID=V346__marketing_integration_contract_probe_runs
export TABLES="marketing_integration_contract_probe_run"
