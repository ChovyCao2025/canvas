# V306 bi dashboard runtime state

Migration: `V306__bi_dashboard_runtime_state.sql`

Touched tables identified from the migration SQL:

- `bi_dashboard_runtime_state`
...
export MIGRATION_ID=V306__bi_dashboard_runtime_state
export TABLES="bi_dashboard_runtime_state"
