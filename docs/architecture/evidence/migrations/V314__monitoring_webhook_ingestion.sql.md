# V314 monitoring webhook ingestion

Migration: `V314__monitoring_webhook_ingestion.sql`
...
export MIGRATION_ID=V314__monitoring_webhook_ingestion
export TABLES="marketing_monitor_source"
