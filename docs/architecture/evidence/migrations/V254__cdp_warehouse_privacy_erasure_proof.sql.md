# V254 cdp warehouse privacy erasure proof

Migration: `V254__cdp_warehouse_privacy_erasure_proof.sql`

Touched tables identified from the migration SQL:

- `cdp_warehouse_privacy_erasure_asset_proof`
- `cdp_warehouse_privacy_erasure_request`
...
export MIGRATION_ID=V254__cdp_warehouse_privacy_erasure_proof
export TABLES="cdp_warehouse_privacy_erasure_asset_proof cdp_warehouse_privacy_erasure_request"
