# V271 bi query cache policy

Migration: `V271__bi_query_cache_policy.sql`

Touched tables identified from the migration SQL:

- `bi_query_cache_policy`
...
export MIGRATION_ID=V271__bi_query_cache_policy
export TABLES="bi_query_cache_policy"
