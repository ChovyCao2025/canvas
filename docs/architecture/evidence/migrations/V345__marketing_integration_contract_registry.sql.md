# V345 marketing integration contract registry

Migration: `V345__marketing_integration_contract_registry.sql`

Touched tables identified from the migration SQL:

- `marketing_integration_contract`
...
export MIGRATION_ID=V345__marketing_integration_contract_registry
export TABLES="marketing_integration_contract"
