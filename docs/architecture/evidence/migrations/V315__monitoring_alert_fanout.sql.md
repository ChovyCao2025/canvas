# V315 monitoring alert fanout

Migration: `V315__monitoring_alert_fanout.sql`

Touched tables identified from the migration SQL:

- `marketing_monitor_alert_channel`
- `marketing_monitor_alert_delivery`
...
export MIGRATION_ID=V315__monitoring_alert_fanout
export TABLES="marketing_monitor_alert_channel marketing_monitor_alert_delivery"
