...
| Migration | Stop rollout. Follow `docs/architecture/evidence/runbooks/flyway-backup-rollback.md`; prefer forward repair migration when production data changed. |
