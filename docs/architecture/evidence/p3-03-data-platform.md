...
- `docs/architecture/data-platform-source-inventory.md`
- `docs/architecture/data-platform-poc-plan.md`
- `docs/architecture/data-platform-contract-governance.md`
...
Stop criteria are recorded in `docs/architecture/data-platform-poc-plan.md`.
