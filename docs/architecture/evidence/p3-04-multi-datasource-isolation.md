...
- `docs/architecture/datasource-ownership-map.md`
- `docs/architecture/datasource-transaction-boundary-map.md`
- `docs/architecture/datasource-migration-plan.md`
...
- Table assignment is recorded in `docs/architecture/datasource-ownership-map.md`.
- Cross-group write flows are classified as same-datasource, outbox, saga, reconciliation, or blocked in `docs/architecture/datasource-transaction-boundary-map.md`.
- Migration, rollback, and monitoring rules are recorded in `docs/architecture/datasource-migration-plan.md`.
