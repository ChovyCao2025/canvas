...
The P3 boundary decision was verified against current backend packages, controllers, mappers, and migrations. The supporting report is [../archive/specs/P3-00-architecture-boundary-code-verification.md](../archive/specs/P3-00-architecture-boundary-code-verification.md).
