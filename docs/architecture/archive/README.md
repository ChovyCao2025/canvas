...
This folder contains source documents that were processed into reviewed architecture packages, plus completed spec/plan packages.

## Categories

- `reference/`: stable architecture references and summaries.
