...
- Read: `docs/architecture/archive/specs/P3-00-architecture-boundary-code-verification.md`
...
- Modify: `docs/architecture/archive/plans/P3-02-service-decomposition-and-domain-boundaries-plan.md`
- Modify: `docs/architecture/archive/plans/P3-03-data-platform-architecture-plan.md`
- Modify: `docs/architecture/archive/plans/P3-08-wecom-scrm-module-plan.md`
...
**Run:**
```bash
rg "P3-00-architecture-boundary-review-spec.md|p3-00-architecture-boundary-review.md|service extraction|bounded context" docs/architecture/archive/plans/P3-*.md docs/architecture/archive/specs/P3-*.md
rg "immediate physical service|split all services|big-bang" docs/architecture/archive/plans/P3-*.md docs/architecture/archive/specs/P3-*.md --glob '!P3-00-architecture-boundary-review-plan.md'
```
...
**Files:**
- Modify: `docs/architecture/archive/plans/P3-00-architecture-boundary-review-plan.md`
- Create: `docs/architecture/evidence/p3-00-architecture-boundary-review.md`
- Modify: `docs/architecture/adr/ADR-0000-template.md`
- Create: `docs/architecture/adr/ADR-0006-service-extraction-gate.md`
...
**Run:**
```bash
git diff -- docs/architecture/archive/plans/P3-00-architecture-boundary-review-plan.md docs/architecture/evidence/p3-00-architecture-boundary-review.md docs/architecture/adr/ADR-0000-template.md docs/architecture/adr/ADR-0006-service-extraction-gate.md docs/architecture/archive/plans/P3-02-service-decomposition-and-domain-boundaries-plan.md docs/architecture/archive/plans/P3-03-data-platform-architecture-plan.md docs/architecture/archive/plans/P3-06-k8s-deployment-platform-plan.md docs/architecture/archive/plans/P3-07-production-platform-components-plan.md docs/architecture/archive/plans/P3-08-wecom-scrm-module-plan.md
```
