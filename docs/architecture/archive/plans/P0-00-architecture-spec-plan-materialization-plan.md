...
**Goal:** Materialize the reviewed architecture work into priority-prefixed spec and plan files under `docs/architecture/archive/specs/` and `docs/architecture/archive/plans/`, with stable indexes and coverage-matrix traceability.

**Architecture:** `docs/architecture/todo/` remains the active work queue and traceability root. `docs/architecture/archive/specs/` and `docs/architecture/archive/plans/` are flattened handoff views. The current set contains 18 source todo packages plus 9 expanded P3 architecture evolution/boundary packages, for 27 package specs and 27 package plans. This P0-00 plan is the materialization closure plan, and `P3-00-architecture-boundary-code-verification.md` is a supporting verification sidecar rather than a package spec.
...
- Specs index: `docs/architecture/archive/specs/README.md`
- Plans index: `docs/architecture/archive/plans/README.md`
...
- Package specs: `docs/architecture/archive/specs/P*-*-spec.md`
- Package plans: `docs/architecture/archive/plans/P*-*-plan.md`
- Supporting sidecar: `docs/architecture/archive/specs/P3-00-architecture-boundary-code-verification.md`

## Task 1: Materialize Specs

**Files:**
- Source: `docs/architecture/todo/*/*/spec.md`
- Destination: `docs/architecture/archive/specs/P*-*-spec.md`
- Supporting: `docs/architecture/todo/coverage-matrix.md`

- [x] Define the canonical materialized package order.
- [x] Materialize package specs into `docs/architecture/archive/specs/`.
...
```bash
missing=0
for f in docs/architecture/archive/specs/P*-*-spec.md; do
...
- Destination: `docs/architecture/archive/plans/P*-*-plan.md`
...
```bash
missing=0
for f in docs/architecture/archive/plans/P*-*-plan.md; do
...
**Files:**
- `docs/architecture/archive/specs/README.md`
- `docs/architecture/archive/plans/README.md`
...
rg -n "P0-01-security-hardening|P3-09-identity-event-and-tenant-platform" \
  docs/architecture/archive/specs/README.md docs/architecture/archive/plans/README.md
```
...
**Files:**
- `docs/architecture/archive/specs/`
- `docs/architecture/archive/plans/`
- `docs/architecture/index.md`
- `docs/architecture/todo/README.md`
- `docs/architecture/todo/coverage-matrix.md`
...
for f in docs/architecture/archive/specs/P*-*-spec.md; do
  ...
  p="docs/architecture/archive/plans/${b}-plan.md"
...
for f in docs/architecture/archive/plans/P*-*-plan.md; do
  ...
  s="docs/architecture/archive/specs/${b}-spec.md"
...
for f in docs/architecture/archive/specs/P*-*-spec.md; do
  base=$(basename "$f")
  rg -q "$base" docs/architecture/archive/specs/README.md docs/architecture/archive/plans/README.md docs/architecture/todo/coverage-matrix.md \
...
- `docs/architecture/archive/plans/P1-03-frontend-canvas-state-plan.md`: `insert placeholder` is a real frontend canvas state term.
- `docs/architecture/archive/plans/P2-03-documentation-adr-and-runbooks-plan.md`: `dashboard link placeholder` is an explicit runbook template field to be filled by the implementing team.
