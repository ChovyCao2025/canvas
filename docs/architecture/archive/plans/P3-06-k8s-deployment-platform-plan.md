...
- Modify: `docs/architecture/archive/plans/P3-06-k8s-deployment-platform-plan.md`
...
git diff -- deploy/helm/canvas docs/architecture/k8s-operating-model.md docs/architecture/runbooks/k8s-rollout-rollback.md docs/architecture/evidence/p3-06-k8s-platform.md docs/architecture/archive/plans/P3-06-k8s-deployment-platform-plan.md
