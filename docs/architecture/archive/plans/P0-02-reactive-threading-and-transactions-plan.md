...
- Spec: `docs/architecture/archive/specs/P0-02-reactive-threading-and-transactions-spec.md`
- Plan: `docs/architecture/archive/plans/P0-02-reactive-threading-and-transactions-plan.md`
