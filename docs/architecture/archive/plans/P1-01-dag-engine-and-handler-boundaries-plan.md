...
**Files:**
- Docs: `docs/architecture/evidence/P1-01-dag-engine-boundaries.md`
- Plan: `docs/architecture/archive/plans/P1-01-dag-engine-and-handler-boundaries-plan.md`
- Spec: `docs/architecture/archive/specs/P1-01-dag-engine-and-handler-boundaries-spec.md`
