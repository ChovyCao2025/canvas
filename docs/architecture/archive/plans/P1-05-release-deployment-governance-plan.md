...
**Files:**
- Evidence: `docs/architecture/evidence/P1-05-release-deployment-governance.md`
- Plan: `docs/architecture/archive/plans/P1-05-release-deployment-governance-plan.md`
- Spec: `docs/architecture/archive/specs/P1-05-release-deployment-governance-spec.md`
