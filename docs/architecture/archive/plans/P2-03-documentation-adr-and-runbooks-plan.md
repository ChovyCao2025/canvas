...
- Read: `docs/architecture/archive/specs/P2-03-documentation-adr-and-runbooks-spec.md`
...
**Files:**
- Modify: `docs/architecture/archive/specs/README.md`
...
**Run:**
```bash
rg "archive|historical evidence|active decisions|ADRs|runbooks" docs/architecture/archive/specs/README.md docs/architecture/archive/plans/README.md
```
...
**Files:**
- Modify: `docs/architecture/archive/plans/P2-03-documentation-adr-and-runbooks-plan.md`
- Modify: `docs/architecture/archive/specs/README.md`
- Modify: `docs/architecture/archive/plans/README.md`
