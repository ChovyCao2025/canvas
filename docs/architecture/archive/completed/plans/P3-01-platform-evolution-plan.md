...
- Read: `docs/architecture/archive/completed/plans/P3-06-k8s-deployment-platform-plan.md`
...
- Read: `docs/architecture/archive/completed/specs/P1-05-release-deployment-governance-spec.md`
...
- Read: `docs/architecture/archive/completed/specs/P3-05-webflux-to-mvc-migration-spec.md`
- Read: `docs/architecture/archive/completed/specs/P3-06-k8s-deployment-platform-spec.md`
- Read: `docs/architecture/archive/completed/specs/P3-07-production-platform-components-spec.md`
- Read: `docs/architecture/archive/completed/specs/P3-08-wecom-scrm-module-spec.md`
- Read: `docs/architecture/archive/completed/specs/P3-09-identity-event-and-tenant-platform-spec.md`
...
**Run:**
```bash
git diff -- docs/architecture/archive/completed/plans/P3-01-platform-evolution-plan.md docs/architecture/plans/README.md docs/architecture/todo/coverage-matrix.md docs/architecture/evidence/p3-01-platform-evolution.md docs/architecture/platform-evolution-promotion-checklist.md
```
