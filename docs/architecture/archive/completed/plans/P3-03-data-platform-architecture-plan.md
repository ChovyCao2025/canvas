...
**Run:**
```bash
git diff -- docs/architecture/archive/completed/plans/P3-03-data-platform-architecture-plan.md docs/architecture/evidence/p3-03-data-platform.md docs/architecture/data-platform-source-inventory.md docs/architecture/data-platform-poc-plan.md docs/architecture/data-platform-contract-governance.md
```
