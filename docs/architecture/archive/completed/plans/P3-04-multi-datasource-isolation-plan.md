...
git diff -- docs/architecture/evidence/p3-04-multi-datasource-isolation.md docs/architecture/datasource-ownership-map.md docs/architecture/datasource-transaction-boundary-map.md docs/architecture/datasource-migration-plan.md docs/architecture/archive/completed/plans/P3-04-multi-datasource-isolation-plan.md
```
