...
This map uses the seven bounded contexts from `docs/architecture/specs/P3-00-architecture-boundary-review-spec.md` and `docs/architecture/evidence/p3-00-architecture-boundary-review.md`.
