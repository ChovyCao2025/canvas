# P2-009 - Product Usage Analytics And Feedback Loop Spec
...
- Page, feature, and action event schema.
- In-app feedback and NPS capture.
- Runtime feature flags for product experiments.
- Alert rules for product health metrics.
...
- `backend/canvas-engine/src/main/resources/db/migration/V168__product_usage_analytics_feedback.sql`
