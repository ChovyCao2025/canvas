# P2-012 - Channel Intelligence And Scheduling Spec
...
- Rule-based channel routing MVP.
- Marketing calendar and conflict detection.
- Channel cost tracking.
- Data capture for send-time optimization.
