# Mautic Inspired Quick Adoptions Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Adopt practical Mautic-inspired improvements: dynamic segment sending, safer previews, canvas import/export, lightweight project grouping, and AI policy clarity.
...
- `docs/product-evolution/specs/p1-003-mautic-inspired-quick-adoptions.md`
- Source item: `docs/product-evolution/todo/p1/mautic-inspired-quick-adoptions.md`
...
**Files:**
- Create or modify: `backend/canvas-engine/src/test/java/org/chovy/canvas/controller/AudienceControllerTest.java`
- Create or modify: `frontend/src/pages/canvas-list/importExportFlow.test.tsx`
- Read: `docs/product-evolution/specs/p1-003-mautic-inspired-quick-adoptions.md`

- [ ] **Step 1: Write backend contract tests**

Create `backend/canvas-engine/src/test/java/org/chovy/canvas/controller/AudienceControllerTest.java` with tests for authorization, tenant scoping, and the main success path named after `mautic-inspired-quick-adoptions`. Use existing controller or service tests in `backend/canvas-engine/src/test/java/org/chovy/canvas` as style references.

- [ ] **Step 2: Run backend contract tests and confirm red state**

Run: `cd backend && mvn -pl canvas-engine test -Dtest=AudienceControllerTest`
...
Create `frontend/src/pages/canvas-list/importExportFlow.test.tsx` with Vitest coverage for loading, empty, success, permission, and server-error states for the first UI slice.

- [ ] **Step 4: Run frontend workflow tests and confirm red state**

Run: `cd frontend && npm test -- importExportFlow.test.tsx`
...
- `frontend/src/pages/canvas-editor/index.tsx`
- `frontend/src/pages/canvas-list/index.tsx`
- Test: `frontend/src/pages/canvas-list/importExportFlow.test.tsx`
...
**Files:**
- Modify: `docs/product-evolution/specs/p1-003-mautic-inspired-quick-adoptions.md`
- Modify: `docs/product-evolution/plans/p1-003-mautic-inspired-quick-adoptions-plan.md`
...
Run: `git add backend/canvas-engine/src frontend/src docs/product-evolution/specs docs/product-evolution/plans && git commit -m "feat: implement mautic-inspired-quick-adoptions slice"`
