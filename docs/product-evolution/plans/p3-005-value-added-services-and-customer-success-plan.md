...
**Goal:** Explore managed service, consulting, training, certification, health scoring, churn alerts, renewal workflow, and expansion detection.
...
**Frontend**
- `frontend/src/pages/value-added-services-and-customer-success/index.tsx`
...
Create `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/ValueAddedServicesAndCustomerSuccessTest.java` with tests for authorization, tenant scoping, and the main success path named after `value-added-services-and-customer-success`. Use existing controller or service tests in `backend/canvas-engine/src/test/java/org/chovy/canvas` as style references.

- [ ] **Step 2: Run backend contract tests and confirm red state**

Run: `cd backend && mvn -pl canvas-engine test -Dtest=ValueAddedServicesAndCustomerSuccessTest`
...
Create `frontend/src/pages/value-added-services-and-customer-success/value-added-services-and-customer-success.test.tsx` with Vitest coverage for loading, empty, success, permission, and server-error states for the first UI slice.

- [ ] **Step 4: Run frontend workflow tests and confirm red state**

Run: `cd frontend && npm test -- value-added-services-and-customer-success.test.tsx`
...
- `frontend/src/pages/value-added-services-and-customer-success/index.tsx`
- `frontend/src/services/valueaddedservicesandcustomersuccessApi.ts`
- Test: `frontend/src/pages/value-added-services-and-customer-success/value-added-services-and-customer-success.test.tsx`
...
**Files:**
- Modify: `docs/product-evolution/specs/p3-005-value-added-services-and-customer-success.md`
- Modify: `docs/product-evolution/plans/p3-005-value-added-services-and-customer-success-plan.md`
...
Run: `git add backend/canvas-engine/src frontend/src docs/product-evolution/specs docs/product-evolution/plans && git commit -m "feat: implement value-added-services-and-customer-success slice"`
