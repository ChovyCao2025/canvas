...
**Goal:** Create an AI Gateway, AI policy, AI copy, segment builder, journey builder, optimizer, anomaly detection, prediction, and human-approved agents.
...
**Backend**
- `backend/canvas-engine/src/main/java/org/chovy/canvas/domain/ainativemarketingoperations/AINativeMarketingOperationsService.java`
- `backend/canvas-engine/src/main/java/org/chovy/canvas/web/AINativeMarketingOperationsController.java`

**Frontend**
- `frontend/src/pages/ai-native-marketing-operations/index.tsx`
- `frontend/src/services/ainativemarketingoperationsApi.ts`

**Data And Config**
- `backend/canvas-engine/src/main/resources/db/migration/V113__ai_native_marketing_operations.sql`

**Tests**
- `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/AiNativeMarketingOperationsTest.java`
- `frontend/src/pages/ai-native-marketing-operations/ai-native-marketing-operations.test.tsx`

### Task 1: Contract And Failing Tests

**Files:**
- Create or modify: `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/AiNativeMarketingOperationsTest.java`
- Create or modify: `frontend/src/pages/ai-native-marketing-operations/ai-native-marketing-operations.test.tsx`
- Read: `docs/product-evolution/specs/p3-007-ai-native-marketing-operations.md`

- [ ] **Step 1: Write backend contract tests**

Create `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/AiNativeMarketingOperationsTest.java` with tests for authorization, tenant scoping, and the main success path named after `ai-native-marketing-operations`. Use existing controller or service tests in `backend/canvas-engine/src/test/java/org/chovy/canvas` as style references.

- [ ] **Step 2: Run backend contract tests and confirm red state**

Run: `cd backend && mvn -pl canvas-engine test -Dtest=AiNativeMarketingOperationsTest`
...
Create `frontend/src/pages/ai-native-marketing-operations/ai-native-marketing-operations.test.tsx` with Vitest coverage for loading, empty, success, permission, and server-error states for the first UI slice.

- [ ] **Step 4: Run frontend workflow tests and confirm red state**

Run: `cd frontend && npm test -- ai-native-marketing-operations.test.tsx`
...
- `backend/canvas-engine/src/main/java/org/chovy/canvas/web/AINativeMarketingOperationsController.java`
- `backend/canvas-engine/src/main/resources/db/migration/V113__ai_native_marketing_operations.sql`
- Test: `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/AiNativeMarketingOperationsTest.java`
...
- `frontend/src/pages/ai-native-marketing-operations/index.tsx`
- `frontend/src/services/ainativemarketingoperationsApi.ts`
- Test: `frontend/src/pages/ai-native-marketing-operations/ai-native-marketing-operations.test.tsx`
...
**Files:**
- Modify: `docs/product-evolution/specs/p3-007-ai-native-marketing-operations.md`
- Modify: `docs/product-evolution/plans/p3-007-ai-native-marketing-operations-plan.md`
...
Run: `git add backend/canvas-engine/src frontend/src docs/product-evolution/specs docs/product-evolution/plans && git commit -m "feat: implement ai-native-marketing-operations slice"`
