...
**Data And Config**
- `backend/canvas-engine/src/main/resources/db/migration/V122__ai_native_marketing_operations.sql`
...
**Files:**
- Create: `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/AiNativeMarketingOperationsTest.java`
- Create: `frontend/src/pages/ai-native-marketing-operations/ai-native-marketing-operations.test.tsx`
