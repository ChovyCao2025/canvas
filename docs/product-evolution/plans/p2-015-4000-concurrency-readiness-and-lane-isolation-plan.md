...
- Optimization sources: `docs/optimization/archive/4000-concurrency-readiness-checklist.md`, `docs/optimization/archive/3000-concurrency-hardening-checklist.md`, `docs/optimization/archive/production-design-gaps.md`
...
- [x] **Step 2: Run the profile test and confirm red state**
...
- [x] **Step 3: Add the 4000 readiness profile**
...
- [x] **Step 4: Extend the hardening profile validator**
...
- [x] **Step 5: Run profile validation**
...
- [x] **Step 1: Write cost profile tests**
...
- [x] **Step 2: Write lane worker isolation tests**
...
- [x] **Step 3: Run cost and isolation tests and confirm red state**
...
- [x] **Step 4: Implement `DagCostProfiler`**
...
- [x] **Step 5: Implement lane worker isolation**
...
- [x] **Step 6: Integrate cost profile into lane resolution**
...
- [x] **Step 1: Write retry and bulkhead tests**
...
- [x] **Step 3: Implement adaptive retry policy**
...
- [x] **Step 4: Implement downstream bulkhead registry**
...
- [x] **Step 5: Integrate retry policy**
...
- [x] **Step 1: Add async writer counters**
...
- [x] **Step 2: Add Redis role configuration guards**
...
- [x] **Step 3: Add readiness runbook**
...
- [x] **Step 1: Run all readiness tests**
