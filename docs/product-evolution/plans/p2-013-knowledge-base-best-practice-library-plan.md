...
**Goal:** Turn template seed data into a browsable best-practice library with contextual help, playbooks, FAQ, benchmarks, and case studies.
...
**Files:**
- Create or modify: `backend/canvas-engine/src/test/java/org/chovy/canvas/domain/knowledge/KnowledgeBaseServiceTest.java`
- Create or modify: `frontend/src/pages/knowledge-base/knowledgeBase.test.tsx`
- Read: `docs/product-evolution/specs/p2-013-knowledge-base-best-practice-library.md`

- [ ] **Step 1: Write backend contract tests**

Create `backend/canvas-engine/src/test/java/org/chovy/canvas/domain/knowledge/KnowledgeBaseServiceTest.java` with tests for authorization, tenant scoping, and the main success path named after `knowledge-base-best-practice-library`. Use existing controller or service tests in `backend/canvas-engine/src/test/java/org/chovy/canvas` as style references.

- [ ] **Step 2: Run backend contract tests and confirm red state**

Run: `cd backend && mvn -pl canvas-engine test -Dtest=KnowledgeBaseServiceTest`
...
Create `frontend/src/pages/knowledge-base/knowledgeBase.test.tsx` with Vitest coverage for loading, empty, success, permission, and server-error states for the first UI slice.

- [ ] **Step 4: Run frontend workflow tests and confirm red state**

Run: `cd frontend && npm test -- knowledgeBase.test.tsx`
...
- `backend/canvas-engine/src/main/java/org/chovy/canvas/domain/knowledge/KnowledgeBaseService.java`
- `backend/canvas-engine/src/main/resources/db/migration/V106__knowledge_base_best_practices.sql`
- Test: `backend/canvas-engine/src/test/java/org/chovy/canvas/domain/knowledge/KnowledgeBaseServiceTest.java`
...
- `frontend/src/pages/knowledge-base/index.tsx`
- `frontend/src/components/help/ContextualHelp.tsx`
- Test: `frontend/src/pages/knowledge-base/knowledgeBase.test.tsx`
...
Run: `git add backend/canvas-engine/src frontend/src docs/product-evolution/specs docs/product-evolution/plans && git commit -m "feat: implement knowledge-base-best-practice-library slice"`
