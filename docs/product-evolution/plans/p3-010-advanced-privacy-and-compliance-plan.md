...
**Data And Config**
- `backend/canvas-engine/src/main/resources/db/migration/V116__advanced_privacy_and_compliance.sql`
...
**Files:**
- Create or modify: `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/AdvancedPrivacyAndComplianceTest.java`
- Create or modify: `frontend/src/pages/advanced-privacy-and-compliance/advanced-privacy-and-compliance.test.tsx`
