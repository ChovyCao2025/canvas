...
**Files:**
- Create or modify: `backend/canvas-engine/src/test/java/org/chovy/canvas/engine/plugin/PluginRegistryServiceTest.java`
- Create or modify: `frontend/src/pages/api-docs/pluginIntegrationDocs.test.tsx`
