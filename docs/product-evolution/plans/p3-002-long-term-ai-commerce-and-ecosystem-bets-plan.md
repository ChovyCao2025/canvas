...
**Goal:** Preserve and sequence AI agents, AI-native operations, commercial expansion, industry expansion, globalization, privacy, and advanced architecture as validated bets.
...
**Backend**
- `backend/canvas-engine/src/main/java/org/chovy/canvas/domain/longtermaicommerceandecosystembets/LongTermAICommerceAndEcosystemBetsService.java`
- `backend/canvas-engine/src/main/java/org/chovy/canvas/web/LongTermAICommerceAndEcosystemBetsController.java`

**Frontend**
- `frontend/src/pages/long-term-ai-commerce-and-ecosystem-bets/index.tsx`
- `frontend/src/services/longtermaicommerceandecosystembetsApi.ts`
...
**Files:**
- Create or modify: `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/LongTermAiCommerceAndEcosystemBetsTest.java`
- Create or modify: `frontend/src/pages/long-term-ai-commerce-and-ecosystem-bets/long-term-ai-commerce-and-ecosystem-bets.test.tsx`
- Read: `docs/product-evolution/specs/p3-002-long-term-ai-commerce-and-ecosystem-bets.md`

- [ ] **Step 1: Write backend contract tests**

Create `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/LongTermAiCommerceAndEcosystemBetsTest.java` with tests for authorization, tenant scoping, and the main success path named after `long-term-ai-commerce-and-ecosystem-bets`. Use existing controller or service tests in `backend/canvas-engine/src/test/java/org/chovy/canvas` as style references.

- [ ] **Step 2: Run backend contract tests and confirm red state**

Run: `cd backend && mvn -pl canvas-engine test -Dtest=LongTermAiCommerceAndEcosystemBetsTest`
...
Create `frontend/src/pages/long-term-ai-commerce-and-ecosystem-bets/long-term-ai-commerce-and-ecosystem-bets.test.tsx` with Vitest coverage for loading, empty, success, permission, and server-error states for the first UI slice.

- [ ] **Step 4: Run frontend workflow tests and confirm red state**

Run: `cd frontend && npm test -- long-term-ai-commerce-and-ecosystem-bets.test.tsx`
...
- `backend/canvas-engine/src/main/java/org/chovy/canvas/web/LongTermAICommerceAndEcosystemBetsController.java`
- `backend/canvas-engine/src/main/resources/db/migration/V108__long_term_ai_commerce_and_ecosystem_bets.sql`
- Test: `backend/canvas-engine/src/test/java/org/chovy/canvas/strategy/LongTermAiCommerceAndEcosystemBetsTest.java`
...
- `frontend/src/pages/long-term-ai-commerce-and-ecosystem-bets/index.tsx`
- `frontend/src/services/longtermaicommerceandecosystembetsApi.ts`
- Test: `frontend/src/pages/long-term-ai-commerce-and-ecosystem-bets/long-term-ai-commerce-and-ecosystem-bets.test.tsx`
...
Run: `git add backend/canvas-engine/src frontend/src docs/product-evolution/specs docs/product-evolution/plans && git commit -m "feat: implement long-term-ai-commerce-and-ecosystem-bets slice"`
