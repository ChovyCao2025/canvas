...
**Goal:** Build a unified message template center for template CRUD, variables, channel adaptation, preview, and approval.
...
**Data And Config**
- `backend/canvas-engine/src/main/resources/db/migration/V99__message_template_center.sql`
...
**Files:**
- Create or modify: `backend/canvas-engine/src/test/java/org/chovy/canvas/domain/template/MessageTemplateServiceTest.java`
- Create or modify: `frontend/src/pages/message-templates/messageTemplateCenter.test.tsx`
- Read: `docs/product-evolution/specs/p2-005-message-template-center.md`

- [ ] **Step 1: Write backend contract tests**

Create `backend/canvas-engine/src/test/java/org/chovy/canvas/domain/template/MessageTemplateServiceTest.java` with tests for authorization, tenant scoping, and the main success path named after `message-template-center`. Use existing controller or service tests in `backend/canvas-engine/src/test/java/org/chovy/canvas` as style references.

- [ ] **Step 2: Run backend contract tests and confirm red state**

Run: `cd backend && mvn -pl canvas-engine test -Dtest=MessageTemplateServiceTest`
...
Create `frontend/src/pages/message-templates/messageTemplateCenter.test.tsx` with Vitest coverage for loading, empty, success, permission, and server-error states for the first UI slice.

- [ ] **Step 4: Run frontend workflow tests and confirm red state**

Run: `cd frontend && npm test -- messageTemplateCenter.test.tsx`
...
- `backend/canvas-engine/src/main/java/org/chovy/canvas/domain/template/MessageTemplateService.java`
- `backend/canvas-engine/src/main/resources/db/migration/V99__message_template_center.sql`
- Test: `backend/canvas-engine/src/test/java/org/chovy/canvas/domain/template/MessageTemplateServiceTest.java`
...
- `frontend/src/pages/message-templates/index.tsx`
- `frontend/src/services/messageTemplateApi.ts`
- Test: `frontend/src/pages/message-templates/messageTemplateCenter.test.tsx`
...
Run: `git add backend/canvas-engine/src frontend/src docs/product-evolution/specs docs/product-evolution/plans && git commit -m "feat: implement message-template-center slice"`
