...
**Data And Config**
- `backend/canvas-engine/src/main/resources/db/migration/V104__message_template_center.sql`
...
- Create: `frontend/src/pages/message-templates/messageTemplateCenter.test.tsx`
