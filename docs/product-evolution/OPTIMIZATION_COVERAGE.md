...
| P1-004 | 3000 Concurrency Hardening Gate | Existing 3000 checklist is specific and actionable, but must become executable gates. | [Spec](specs/p1-004-3000-concurrency-hardening-gate.md) | [Plan](plans/p1-004-3000-concurrency-hardening-gate-plan.md) |
