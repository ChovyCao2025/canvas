# DDD-E01 Read-Only Dispatch Recovery Note
...
This dispatch is read-only and owns no files. The explorer must report HTTP
route inventory findings for DDD-C09 cutover planning and must not edit source,
