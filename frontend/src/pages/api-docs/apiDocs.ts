...
export const API_DOCS: ApiDocEndpoint[] = [
  ...
  endpoint({ title: '更新 API 定义', method: 'PUT', path: '/canvas/api-definitions/{id}', category: 'configuration', internal: true, summary: '更新 API 配置。' }),
  ...
  endpoint({ title: '更新事件定义', method: 'PUT', path: '/canvas/event-definitions/{id}', category: 'configuration', internal: true, summary: '更新事件配置。' }),
  ...
  endpoint({ title: '更新 MQ 定义', method: 'PUT', path: '/canvas/mq-definitions/{id}', category: 'configuration', internal: true, summary: '更新 MQ 触发配置。' }),
  ...
  endpoint({ title: '更新标签定义', method: 'PUT', path: '/canvas/tag-definitions/{id}', category: 'configuration', internal: true, summary: '更新用户标签配置。' }),
  ...
  endpoint({ title: '更新实验', method: 'PUT', path: '/canvas/ab-experiments/{id}', category: 'configuration', internal: true, summary: '更新 AB 实验配置。' }),
  ...
  endpoint({ title: '更新人群', method: 'PUT', path: '/canvas/audiences/{id}', category: 'configuration', internal: true, summary: '更新人群配置。' }),
  ...
  endpoint({ title: '更新用户', method: 'PUT', path: '/admin/users/{id}', category: 'users', internal: true, summary: '更新后台用户资料和角色。' }),
  endpoint({ title: '禁用用户', method: 'PUT', path: '/admin/users/{id}/disable', category: 'users', internal: true, summary: '禁用指定后台用户。' }),
]
